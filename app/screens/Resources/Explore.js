        ...
        <View style={styles.buttonContainer}>
          ...
          >
            <View style={styles.button2}>
              <Text style={styles.buttonText2}>lesson plans/workshops</Text>
            </View>
          </TouchableOpacity>
          <TouchableOpacity
          ...
          >
            <View style={styles.button1}>
              <Text style={styles.buttonText1}>wellness week resources</Text>
            </View>
          </TouchableOpacity>
          <TouchableOpacity
          ...
          >
            <View style={styles.button2}>
              <Text style={styles.buttonText2}>#scicomm resources</Text>
            </View>
          </TouchableOpacity>
        </View>
      </View>
